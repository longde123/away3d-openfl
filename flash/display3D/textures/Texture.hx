...
@:final extern class Texture extends TextureBase {
	...
	function uploadFromBitmapData(source : flash.display.BitmapData, miplevel : Int = 0) : Void;
	function uploadFromByteArray(data : flash.utils.ByteArray, byteArrayOffset : Int, miplevel : Int = 0) : Void;
}
#else
