...
@:final extern class Context3D extends flash.events.EventDispatcher {
    ...
    function clear(red : Float = 0, green : Float = 0, blue : Float = 0, alpha : Float = 1, depth : Float = 1, stencil : Int = 0, mask : Int = 0xFFFFFFFF) : Void;
    ...
    @:require(flash11_2) function setProgramConstantsFromByteArray(programType : Context3DProgramType, firstRegister : Int, numRegisters : Int, data : flash.utils.ByteArray, byteArrayOffset : Int) : Void;
...
#else
import flash.display3D.Context3D.Location;
import haxe.Timer;
