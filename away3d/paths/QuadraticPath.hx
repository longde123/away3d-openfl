...
class QuadraticPath extends SegmentedPathBase implements IPath {
    public var smoothed(get_smoothed, never):Bool;
    public var averaged(get_averaged, never):Bool;
...
/**
    ...
    public function smoothPath():Void {
        ...
        while (i < numSegments - 1) {
            ...
            if (seg.control == null) seg.control = seg.end;
            if (segnext.control == null) segnext.control = segnext.end;
            seg0 = seg.control;
