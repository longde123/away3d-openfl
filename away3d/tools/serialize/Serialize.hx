...
class Serialize {
    ...
    static public function serializeObjectContainer(objectContainer3D:ObjectContainer3D, serializer:SerializerBase):Void {
        if (Std.is(objectContainer3D, Mesh)) serializeMesh(cast(objectContainer3D, Mesh) catch(e) null, serializer)
    ...
    static public function serializeMesh(mesh:Mesh, serializer:SerializerBase):Void {
        serializeObjectContainerInternal(cast(mesh, ObjectContainer3D) catch(e) null, serializer, false);
        ...
        serializeChildren( cast(mesh, ObjectContainer3D) catch(e) null, serializer);
