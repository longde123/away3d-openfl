...
/**
    ...
    override private function compileLightingCode():Void {
        if (_methodSetup._shadowMethod) compileShadowCode();
        ...
        if (_methodSetup._shadowMethod) _registerCache.removeFragmentTempUsage(_shadowRegister);
    }
...
/**
    ...
    private function compileShadowCode():Void {
        if (_sharedRegisters.normalFragment) _shadowRegister = _sharedRegisters.normalFragment
