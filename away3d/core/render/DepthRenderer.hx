...
/**
    ...
    private function renderCascades(entityCollector:EntityCollector, target:TextureBase, numCascades:Int, scissorRects:Vector<Rectangle>, cameras:Vector<Camera3D>):Void {
