...
class MD5AnimParser extends ParserBase {
    ...
    static private var NUM_FRAMES_TOKEN:String = "numFrames";
    static private var NUM_JOINTS_TOKEN:String = "numJoints";
    static private var FRAME_RATE_TOKEN:String = "frameRate";
    static private var NUM_ANIMATED_COMPONENTS_TOKEN:String = "numAnimatedComponents";
    static private var HIERARCHY_TOKEN:String = "hierarchy";
    static private var BOUNDS_TOKEN:String = "bounds";
    static private var BASE_FRAME_TOKEN:String = "baseframe";
    static private var FRAME_TOKEN:String = "frame";
...
/**
    ...
    private function parseFrame():Void {
        ...
        do {
            ...
            var i:Int = 0;
            while (i < _numAnimatedComponents) {
